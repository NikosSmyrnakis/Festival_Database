...
BEGIN
    ...
    WHERE
        ...
        AND (
            (NEW.performance_start_time BETWEEN performance_start_time - INTERVAL 6 MINUTE AND performance_end_time + INTERVAL 4 MINUTE)
            OR
            (NEW.performance_end_time BETWEEN performance_start_time - INTERVAL 6 MINUTE AND performance_end_time + INTERVAL 4 MINUTE)
            OR
            (performance_start_time BETWEEN NEW.performance_start_time - INTERVAL 6 MINUTE AND NEW.performance_end_time + INTERVAL 4 MINUTE)
            OR
            (performance_end_time BETWEEN NEW.performance_start_time - INTERVAL 6 MINUTE AND NEW.performance_end_time + INTERVAL 4 MINUTE)
        );
